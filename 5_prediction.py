...
def get_recent_data_and_sentiment(ticker, look_back=100):
    ...
    # Use a MUCH longer calendar window to ensure we have >= look_back TRADING days
    ...
    if len(stock_data) < look_back:
        # Better to fail loudly than feed garbage into the model
        print(
        ...
        try:
            ...
            if isinstance(sentiment_data, dict) and sentiment_data:
                ...
                if recent_sentiments:
                    ...
                    # Sanity check: if it's basically all 0.2 anyway, treat as neutral
